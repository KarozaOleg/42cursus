...
/*   Updated: 2020/11/28 14:29:21 by mgaston          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (parser_base(line, "F", parser_color, (void *)
(&(settings->color_floor))) == FOUND)
		return (FOUND);
	if (parser_base(line, "C", parser_color, (void *)
(&(settings->color_ceiling))) == FOUND)
		return (FOUND);
	return (NOT_FOUND);
}
